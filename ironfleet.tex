...
%Talk about what safety/liveness/formal verification are at a high level 

\subsection{Safety Verification}
Most formal verification focuses on verifying safety properties. These
...
specific techniques for verifying liveness properties have been developed, which
we discuss in Section~\ref{sec:rel-work}.
...
on Dafny for describing and proving high level specifications of large systems.
